...
# macos_notification_count.sh {
	...
	# sqlite3 -list "/var/folders/q2/7kv58bm56cn0yjjk9p818wxm0000gn/0//com.apple.notificationcenter/db/db" 'select * from app_info'
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/mmottl/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/mmottl/.mailcheckrc"
# }
...
# weather.sh {
	...
	TMUX_POWERLINE_SEG_WEATHER_LAT="40.83515"
	TMUX_POWERLINE_SEG_WEATHER_LON="-74.10726"
# }

TMUX_POWERLINE_LEFT_STATUS_SEGMENTS=(
		#"mode_indicator 2 0" \
		"hostname 5 16" \
		"tmux_session_info 10 16" \
        "pwd 12 16" \
		#"ifstat 30 255" \
		#"ifstat_sys 30 255" \
...
TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
		...
		"time 12 16 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}" \
